...
public class NewsArticleUserFeature extends AcceptanceTestBase {
    ...
    @Test
    @Title("A user should be able to view one article using article id")
    public void a_user_should_be_able_to_view_one_article_using_article_id() {
        String requestUrl = String.format(getBaseUrl(), "article/1");
        newsArticleUserSteps.given_a_user_has_a_get_article_by_id_endpoint(requestUrl);
    ...
    @Test
    @Title("A user should be able to view all articles for an author")
    public void a_user_should_be_able_to_view_all_articles_for_an_author() {
        String requestUrl = String.format(getBaseUrl(), "article/author/1");
        newsArticleUserSteps.given_a_user_has_a_get_article_by_author_id_endpoint(requestUrl);
    ...
    @Test
    @Title("A user should be able to view all articles for a specific keyword")
    public void a_user_should_be_able_to_view_all_articles_for_a_specific_keyword() {
        String requestUrl = String.format(getBaseUrl(), "article/author/1");
        newsArticleUserSteps.given_a_user_has_a_get_article_by_keyword_endpoint(requestUrl);
    ...
    @Test
    @Title("A user should be able to view all articles for a given period")
    public void a_user_should_be_able_to_view_all_articles_for_a_given_period() {
        ...
        newsArticleUserSteps.given_a_user_has_a_get_article_between_a_period_endpoint(requestUrl);
